...
export function FileList({
    ...
    const { searchTerm, sortKey, sortOrder, setSearchTerm, setSortKey, toggleSortOrder, filteredAndSortedFiles } =
        useFileFilters();
    ...
    const handleDeleteFile = async (id: string) => {
        ...
        try {
            ...
            if (msg === 'Forbidden') {
                alert("Vous n'êtes pas autorisé à supprimer ce fichier");
                return;
            }
            alert(msg || 'Erreur lors de la suppression du fichier');
        }
    };
    ...
    const handleDrop = async (e: React.DragEvent, targetFolderId: string | null) => {
        ...
        try {
            ...
            if (msg === 'Forbidden') {
                alert("Vous n'êtes pas autorisé à déplacer cet élément");
                return;
            }
            alert(msg || 'Erreur lors du déplacement');
        } finally {
            setDraggedFileId(null);
            setDragOverFolderId(null);
        }
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className='file-meta'>
                                        {folder._count ? (
                                            <>
                                                {folder._count.files} fichier(s) • {folder._count.children}{' '}
                                                sous-dossier(s)
                                            </>
                                        ) : (
                                            'Dossier'
